...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var Z=function(){function t(t){this._ngZone=t,this._directionsService=new google.maps.DirectionsService}return t.prototype.route=function(t){var e=this;return new n.Observable((function(i){e._directionsService.route(t,(function(t,n){e._ngZone.run((function(){i.next({result:t,status:n}),i.complete()}))}))}))},t}();Z.ɵprov=a.ɵɵdefineInjectable({factory:function t(){return new Z(a.ɵɵinject(a.NgZone))},token:Z,providedIn:"root"}),Z.decorators=[{type:e.Injectable,args:[{providedIn:"root"}]}],Z.ctorParameters=function(){return[{type:e.NgZone}]};
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
