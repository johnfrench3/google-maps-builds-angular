...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */(t)?new google.maps.LatLng(t.lat,t.lng):t)})),e},t.prototype._assertInitialized=function(){},t}();E.decorators=[{type:e.Directive,args:[{selector:"map-heatmap-layer",exportAs:"mapHeatmapLayer"}]}],E.ctorParameters=function(){return[{type:l},{type:e.NgZone}]},E.propDecorators={data:[{type:e.Input}],options:[{type:e.Input}]};var j,D=[l,y,d,_,m,f,b,v,z,O,I,C,k,w,L,E];(j=function j(){}).decorators=[{type:e.NgModule,args:[{declarations:D,exports:D}]}];
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
t.GoogleMap=l,t.GoogleMapsModule=j,t.MapBaseLayer=y,t.MapBicyclingLayer=d,t.MapCircle=_,t.MapDirectionsRenderer=m,t.MapDirectionsService=x,t.MapGroundOverlay=f,t.MapHeatmapLayer=E,t.MapInfoWindow=b,t.MapKmlLayer=v,t.MapMarker=z,t.MapMarkerClusterer=O,t.MapPolygon=I,t.MapPolyline=C,t.MapRectangle=k,t.MapTrafficLayer=w,t.MapTransitLayer=L,Object.defineProperty(t,"__esModule",{value:!0})}));