!function(t,e){"object"==typeof exports&&"undefined"!=typeof module?e(exports,require("@angular/core"),require("@angular/common"),require("rxjs"),require("rxjs/operators")):"function"==typeof define&&define.amd?define("@angular/google-maps",["exports","@angular/core","@angular/common","rxjs","rxjs/operators"],e):e(((t="undefined"!=typeof globalThis?globalThis:t||self).ng=t.ng||{},t.ng.googleMaps={}),t.ng.core,t.ng.common,t.rxjs,t.rxjs.operators)}(this,(function(t,e,i,n,r){"use strict";function o(t){if(t&&t.__esModule)return t;var e=Object.create(null);return t&&Object.keys(t).forEach((function(i){if("default"!==i){var n=Object.getOwnPropertyDescriptor(t,i);Object.defineProperty(e,i,n.get?n:{enumerable:!0,get:function(){return t[i]}})}})),e.default=t,Object.freeze(e)}var a=o(e),s=function(t,e){return(s=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,e){t.__proto__=e}||function(t,e){for(var i in e)Object.prototype.hasOwnProperty.call(e,i)&&(t[i]=e[i])})(t,e)};
/*! *****************************************************************************
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */(t)?new google.maps.LatLng(t.lat,t.lng):t)})),e},t.prototype._assertInitialized=function(){},t}();D.decorators=[{type:e.Directive,args:[{selector:"map-heatmap-layer",exportAs:"mapHeatmapLayer"}]}],D.ctorParameters=function(){return[{type:h},{type:e.NgZone}]},D.propDecorators={data:[{type:e.Input}],options:[{type:e.Input}]};var x,S=[h,_,m,f,b,v,M,z,I,k,w,L,E,j,P,D];(x=function x(){}).decorators=[{type:e.NgModule,args:[{declarations:S,exports:S}]}];
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var Z=function(){function t(t){this._ngZone=t}return t.prototype.route=function(t){var e=this;return new n.Observable((function(i){e._directionsService||(e._directionsService=new google.maps.DirectionsService),e._directionsService.route(t,(function(t,n){e._ngZone.run((function(){i.next({result:t,status:n}),i.complete()}))}))}))},t}();Z.ɵprov=a.ɵɵdefineInjectable({factory:function t(){return new Z(a.ɵɵinject(a.NgZone))},token:Z,providedIn:"root"}),Z.decorators=[{type:e.Injectable,args:[{providedIn:"root"}]}],Z.ctorParameters=function(){return[{type:e.NgZone}]};
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var R=function(){function t(t){this._ngZone=t}return t.prototype.geocode=function(t){var e=this;return new n.Observable((function(i){e._geocoder||(e._geocoder=new google.maps.Geocoder),e._geocoder.geocode(t,(function(t,n){e._ngZone.run((function(){i.next({results:t,status:n}),i.complete()}))}))}))},t}();R.ɵprov=a.ɵɵdefineInjectable({factory:function t(){return new R(a.ɵɵinject(a.NgZone))},token:R,providedIn:"root"}),R.decorators=[{type:e.Injectable,args:[{providedIn:"root"}]}],R.ctorParameters=function(){return[{type:e.NgZone}]},
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     ...
     * found in the LICENSE file at https://angular.io/license
     */
t.GoogleMap=h,t.GoogleMapsModule=x,t.MapBaseLayer=_,t.MapBicyclingLayer=m,t.MapCircle=f,t.MapDirectionsRenderer=b,t.MapDirectionsService=Z,t.MapGeocoder=R,t.MapGroundOverlay=v,t.MapHeatmapLayer=D,t.MapInfoWindow=M,t.MapKmlLayer=z,t.MapMarker=I,t.MapMarkerClusterer=k,t.MapPolygon=w,t.MapPolyline=L,t.MapRectangle=E,t.MapTrafficLayer=j,t.MapTransitLayer=P,Object.defineProperty(t,"__esModule",{value:!0})}));